...
# Add Alpha-3 country codes for mapping
...
country_poi_counts['ISO_A3'] = country_poi_counts['country'].apply(alpha2_to_alpha3)
...
world = world.merge(country_poi_counts, left_on="id", right_on="ISO_A3", how="left")
