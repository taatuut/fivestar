...
places_s3_path = "s3://fsq-os-places-us-east-1/release/dt=2024-11-19/places/parquet/places.parquet"
categories_s3_path = "s3://fsq-os-places-us-east-1/release/dt=2024-11-19/categories/parquet/categories.parquet"

download_file_from_s3(places_s3_path, places_file)
download_file_from_s3(categories_s3_path, categories_file)
